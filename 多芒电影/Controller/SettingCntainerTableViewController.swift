...
//    }
    ...
    override func tableView(tableView: UITableView, willSelectRowAtIndexPath indexPath: NSIndexPath) -> NSIndexPath? {
        ...
        case 0://分享好友
            ...
            var publishContent = ShareSDK.content("应用分享", defaultContent: "多芒电影，有你好看", image:ShareSDK.imageWithPath(imagePath), title: "应用分享", url: "https://itunes.apple.com/cn/app/duo-mang-dian-ying/id789581054?mt=8&uo=4", description: "多芒电影是一款个性化电影推荐聚合应用，主打品读式移动观影，其简洁清新的界面风格、个性独特的推荐方式，让您在电影的精深世界里尽享慢生活之乐。", mediaType: SSPublishContentMediaTypeNews)
